 ...
 * @return string
 */
function flatsome_render_ux_menu_direct_link_shortcode( $atts, $content, $tag ) {
	global $wp_query;
...
add_shortcode( 'ux_menu_direct_link', 'flatsome_render_ux_menu_direct_link_shortcode' );
