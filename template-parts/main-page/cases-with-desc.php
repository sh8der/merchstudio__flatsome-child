	    ...
	    <article class="case-list__item">
		    <a href="<?=the_permalink()?>" title="<?=the_title()?>">
		        <div class="case-list__thumb-wrapper">
		        	...
		        	<div class="case-list__item-description"><?=get_the_excerpt()?></div>
			        <?php endif; ?>
		        </div>
...
.case-list__item:hover .case-list__item-description {
	opacity: 1;
	backdrop-filter: blur(4px);
}

.case-list__item-description p {margin: 0;}
